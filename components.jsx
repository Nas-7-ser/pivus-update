...
const { Ed, EdImg, EdVideo } = window.PIVUS_EDIT;
  ...
  return (
    <nav className={'nav' + (scrolled ? ' scrolled' : '')}>
      ...
      <div className="nav-links">
        ...
        <a href="equipe.html"><Ed k="nav.equipe">Équipe</Ed></a>
    ...
    <section className="section demo" id="demo">
      <div className="wrap">
        <div className="demo-head reveal">
          <span className="eyebrow">// <Ed k="demo.eyebrow">Démonstration</Ed></span>
          <h2 className="section-title"><Ed k="demo.title">Voir PIVUS en action</Ed></h2>
          <p className="lead"><Ed k="demo.lead">En moins de deux minutes : comment on mesure le mouvement d'un liquide sans le toucher, et ce que révèle le champ de vitesses.</Ed></p>
        </div>
        <div className="demo-frame reveal">
          <EdVideo k="demo.video" className="demo-video" />
        </div>
      </div>
    </section>
  );
...
window.PIVUS_COMPONENTS = { VelocityCanvas, Nav, Hero, VideoDemo, Method, Applications, Products, Positioning };
